  ...
  return (
    <>
      <div className="absolute top-0 bottom-0 left-0 right-0 bg-black/60 z-[1] flex justify-center items-center flex-col">
        <h1 className="text-6xl text-white text-center">{formattedTime}</h1>
        <p className='text-xl py-6 font-extralight text-white text-center'> {dateFormatee}</p>
      ...
      <div className="text-white text-center px-8">
        ...
        <Link href={`/Meteo`} className="bg-transparent border-2 border-white mt-8 text-white hover:text-cyan-600 duration-700 ease-in rounded-md outline-none  py-2 px-6 text-lg">Voir la météo</Link>
